...
return "- **  -> عذرأ هذا الامر يخص .{المدير,المالك,The Dev } فقط  \n"
end
redis:set(black.."getidstatus"..msg.chat_id_, "Simple")
return  "- ** - أهلأ عزيزي"..msg.TheRankCmd.."\n- ** تم تعطيل الايدي بالصوره  \n" 
end 
...
if not msg.Creator then return "- **  -> عذرأ هذا الامر يخص .{المالك,The Dev } فقط  \n"
end
redis:set(black..'lock:kara:'..msg.chat_id_,'on')
return "- ** - أهلأ عزيزي"..msg.TheRankCmd.."\n- ** تم تعطيل الرفع في المجموعة \n"
end
function cmds_off(msg)
if not msg.Creator then return "- **  -> عذرأ هذا الامر يخص .{المالك,The Dev } فقط  \n"
end
redis:set(black..'lock:kara:'..msg.chat_id_,'off')
return "- ** - أهلأ عزيزي"..msg.TheRankCmd.."\n- ** تم تفعيل الرفع في المجموعة \n"
end

function lockjoin(msg)
if not msg.Admin then return "- **  -> عذرأ هذا الامر يخص .{النائب مدير,المدير,المالك,The Dev } فقط  \n"
end
...
if not msg.SudoUser then return "♦️** -> عذرأ هذا الامر يخص .{The Dev } فقط  \n💥" end
...
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️في مجموعه  -> ->  '..redis:get(black..'group:name'..msg.chat_id_))
else
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️عزيزي The Dev  ✋🏿\n👨🏻‍🔧شحن الاشتراك يكون ما بين يوم الى 1000 يوم فقط ')
end 
return false
end
...
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️تم تفعيل الاشتراك   👍🏿\n الاشتراك -> `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️تم تفعيل الاشتراك  👍🏿\n الاشتراك -> `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
...
if not msg.Admin then return "♦️** -> عذرأ هذا الامر يخص .{النائب مدير,المدير,المالك,The Dev } فقط  \n💥" end
...
if not msg.Director then return "** -> عذرأ هذا الامر يخص .{The Dev ,المالك,المدير} فقط  \n" end
...
return sendMsg(msg.chat_id_,msg.id_,'\n- ً- أهلأ عزيزي البوت هنا مشرف . \n- وصلاحياته هي ↓ \n––––––––––––––––––\n- تغير معلومات المجموعة <- ❪ '..info..' ❫\n- حذف الرسائل <- ❪ '..delete..' ❫\n- حظر المستخدمين <- ❪ '..restrict..' ❫\n- دعوة مستخدمين <- ❪ '..invite..' ❫\n- تثبيت الرسائل <- ❪ '..pin..' ❫\n- اضافة مشرفين جدد <- ❪ '..promote..' ❫\n\n- ملاحضه -> علامة ❪  ꪜ ❫ تعني لدية الصلاحية وعلامة ❪ ✘ ❫ تعني ليس لدية الصلاحيه')   
end
end
end
...
return "عذرأ عزيزي ،  لا لا يمكنك التثبيت الامر مقفول من قبل المالكين"
else
tdcli_function({
...
return sendMsg(msg.chat_id_,msg.id_,"- **ً - أهلأ عزيزي"..msg.TheRankCmd.." \n- ** تم تثبيت الرساله \n-")
...
if not msg.Admin then return "** -> عذرأ هذا الامر يخص .{النائب مدير,المدير,المالك,The Dev } فقط  \n" end
if not msg.Director and redis:get(black..'lock_pin'..msg.chat_id_) then
return "عذرأ عزيزي ،  لا يمكنك الغاء التثبيت الامر مقفول من قبل المالكين
"
else
local GroupID = msg.chat_id_:gsub('-100','')
...
sendMsg(msg.chat_id_,msg.id_,"- ** - أهلأ عزيزي"..msg.TheRankCmd.."\n- ** الرفع معطل \n")
end
return false
end
...
if not msg.Creator then return "** -> عذرأ هذا الامر يخص .{The Dev ,المالك} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(black..'lock:kara:'..msg.chat_id_) == 'off' then
...
if not msg.SudoUser then return "** -> عذرأ عزيزي هذا الامر يخص ، {The Dev } فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Kara then return "** -> عذرأ هذا الامر يخص .{المالك الاساسي,The Dev } فقط  \n" end
if not MsgText[2] and msg.reply_id then
...
if not msg.Kara then return "** -> عذرأ هذا الامر يخص {The Dev ,المالك الاساسي } فقط  \n" end
if not MsgText[2] and msg.reply_id then
...
if MsgText[2] == "الأنلاين" 		then return mute_inline(msg) end
...
if MsgText[2] == "الأنلاين" 		then return unmute_inline(msg) 	end
...
if not msg.Admin then return "- ** -> عذرأ هذا الامر يخص .{النائب مدير,المدير,المالك,The Dev } فقط  \n" end
local GroupLink = redis:get(black..'linkGroup'..msg.chat_id_)
if not GroupLink then return "- ** -> عذرأ عزيزي لايوجد رابط\n- *رجاء أكتب [ضع رابط]*" end
...
elseif res == 400 then
return "- **عذرا عزيزي \n- لم استطيع ارسالك الرابط يجب عليك مراسله البوت أولأ \n!"
end
if res == 200 then 
...
local Admins = redis:scard(black..'admins:'..msg.chat_id_)
if Admins ==0 then  
return "- ** اوه هنالك خطأ .\n- عذراً لا يوجد نائب مديريه ليتم مسحهم ." 
end
redis:del(black..'admins:'..msg.chat_id_)
...
if not msg.SudoUser then return "** -> عذرأ هذا الامر يخص .{The Dev } فقط  \n" end
local NumMnsha = redis:scard(black..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "- عذراً لا يوجد مالك اساسي \n!" 
end
...
if NumMnsha ==0 then 
return "- عذراً لا يوجد مالكيين ليتم مسحهم \n!" 
end
...
if not msg.Creator then return "** -> عذرأ هذا الامر يخص .{The Dev ,المالك,المدير} فقط  \n" end
local NumMDER = redis:scard(black..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
...
return sendMsg(msg.chat_id_,msg.id_,'- -> عذرأ عزيزي ليس لدي صلاحية تغيير الصورة \n- يرجى اعطائي صلاحية -> `تغيير معلومات المجموعة ` ⠀\n')
end
end, nil)
end
...
return "- حسنأ عزيزي .\n- الأن ارسل الوصف  للمجموعه\n" 
end


if MsgText[1] == "طرد البوتات" then
if not msg.Director then return "** -> عذرأ هذا الامر يخص .{The Dev ,المالك} فقط  \n" end
...
local Get_info ="- أهلأً بك في معلوماتك . \n"
.."––––––––––––––\n"
...
if MsgText[1] == "رفع نائبين المدراء" then
if not msg.Creator then return "** -> عذرأ هذا الامر يخص .{The Dev ,المالك} فقط  \n" end
...
if MsgText[1] == 'مسح' and MsgText[2] == 'The Dev ين'  then
if not msg.SudoBase then return"** -> عذرأ هذا الامر يخص-> {The Dev } . فقط  \n" end
local mtwren = redis:scard(black..':SUDO_BOT:')
if mtwren == 0 then  return "- ** عذراً لا يوجد Dev Assistantين في البوت ." end
...
if addbannds ==0 then 
return "*- أهلأ بك عزيزي ، قائمة الحظر فارغة .*" 
end
...
if MsgText[1] == "رفع Dev Assistant" then
if not msg.SudoBase then return "** -> عذرأ هذا الامر يخص-> {The Dev } . فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if MsgText[1] == "تنزيل Dev Assistant" then
if not MsgText[2] and msg.reply_id then 
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[- أهلأ انا بوت]]..redis:get(black..':NameBot:')..[[ .
...
return'- ** شـرط التفعيل البوت اذا كانت المجموعة‏‏ اكثر مـن *【'..redis:get(black..':addnumberusers')..'】* عضـو .\n' 
end 
end
...
sendMsg(MsgText[2],0,'- ** تم تعطيل المجموعة بأمر من The Dev   \n- ** سوف اغادر ...\n✘')
rem_data_group(MsgText[2])
StatusLeft(MsgText[2],our_id)
return '- ** تم تعطيل المجموعة ومغادرتها \n- ** المجموعة -> ['..name_gp..']\n- ** الايدي -> ( *'..MsgText[2]..'* )\n'
else 
return '- ** لا توجد مجموعه مفعله بهذا الايدي .\n ' 
end 
end 

if MsgText[1] == 'The Dev ' then
return redis:get(black..":TEXT_SUDO") or '- لا توجد كليشه The Dev  .\n- يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه The Dev ` " \n'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="ااذاعه بالتثبيت ♥" then
if not msg.SudoUser then return"** -> عذرأ هذا الامر يخص .{The Dev } فقط  \n" end
if not msg.SudoBase and not redis:get(black..'lock_brod') then return "- ** الاذاعه مقفوله من قبل The Dev  الاساسي ." end
redis:setex(black..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "- حسنأ عزيزي الأن ارسل الكليشة ب التثبيت .  \n ♥" 
end
...
return "- ** الاذاعه مقفوله من قبل The Dev  الاساسي  ." 
end
redis:setex(black..'fwd:'..msg.sender_user_id_,300, true) 
return "- - حسنأ عزيزي الأن ارسل التوجية ل الاذاعة . \n" 
end
...
return "- - حسنأ عزيزي الأن ارسل الكليشة ل الاذاعة عام . \n" 
end
...
return "- - حسنأ عزيزي الأن ارسل الكليشة ل الاذاعة في الخاص . \n"
end
...
return "- حسنأ عزيزي الأن ارسل الكليشة ل الاذاعة في المجموعات . \n" 
end

if MsgText[1] == "The Dev ين" or MsgText[1] == "المطورين 🔥" then
if not msg.SudoUser then return"** -> عذرأ هذا الامر يخص .{The Dev } فقط  \n- " end
return sudolist(msg) 
end
...
return "** -> عذرأ هذا الامر يخص-> {The Dev } . فقط  \n" 
end
...
sendMsg(msg.chat_id_,msg.id_,' *<-* يوجد تحديث جديد الأن \n*،* جاري تنزيل وتثبيت التحديث  ...' )
...
if MsgText[1]== "The Dev  الجوكر" and msg.type == "pv" then
local inline = {{{text="-Dev Assistant السورس اضـغـط هـنـآ ",url="https://t.me/A_j_o_k_e_r"}}}
send_key(msg.sender_user_id_,'   [Dev Assistant السورس](https://t.me/A_j_o_k_e_r)' ,nil,inline,msg.id_)
return false
end
...
return "- حسنأ الأن ارسل كلمة الرد العام .\n"
end
...
if not msg.SudoBase then return"- للDev Assistantين فقط ." end
...
if not msg.SudoBase then return "- للDev Assistant فقط ." end
...
【▣】رفع ⇦⇨ تنزيل مميز .
––––––––––––––
       ٢ - اوامـر المسح للمالك .
––––––––––––––
 【▣】مسح النائب مديرـيـه ➢ لمسح نائبين المدراء
...
【▣】نائبين المدراء ➢ لعرض نائبين المدراء
...
if not msg.Director then return "** -> عذرأ هذا الامر يخص .{The Dev ,المالك,المدير,The Dev } فقط  \n- " end
local text = [[
-  اوامر الخدمــه .
–––––––––––––– 
...
if MsgText[1]== "م The Dev " then
if not msg.SudoBase then return "- للDev Assistant الاساسي فقط  🎖" end
local text = [[     
↤︎ ❬اوامـر المطـور❭ 
––––––––––––––
- تفعيـل ⇦⇨ ❬لتفعيل البوت ❭
- تعطيل ⇦⇨ ❬لتعطيل البوت ❭
- رفع مالك ⇦⇨ ❬رفع مالك بالبوت❭
––––––––––––––
...
return "- **- أهلأ عزيزي"..msg.TheRankCmd.."\n- ** اطردني من قبل البوت بالتأكيد معطله\n-" 
else
redis:set(black..'lave_me'..msg.chat_id_,true)  
return "- **- أهلأ عزيزي"..msg.TheRankCmd.."\n- ** تم تعطيل اطردني من قبل البوت\n-" 
end   
end

if MsgText[1] == "اطردني" or MsgText[1] == "احظرني" then
if not redis:get(black..'lave_me'..msg.chat_id_) then
if msg.Admin then return "- **لا استطيع طرد المدراء ونائبين المدراء والمالكين  \n- " end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"- أهلاً عزيزي , لقد تم طردك من المجموعة بامر منك \n- اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n- فهذا رابط المجموعة\n- "..Flter_Markdown(redis:get(black..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(black..'linkGroup'..msg.chat_id_).."]\n")
sendMsg(msg.chat_id_,msg.id_,"- لقد تم طردك  , ارسلت لك رابط المجموعة في الخاص تستطيع الرجوع متى شئت ")
else
...
الظابط محمد: والله انت مكبر الموضوع يا دكتور انت السلام عليكم ورحمة الله وبركاتة . بقي انا مش محتاج معايا غرب دا انت متخيل دا لو انا مسكته نص ساعه ممكن اخليه يقول انا اللي كسرت منخير ابو الهول.
...
مصطفي:كل شي معلوم يا دكتور وبعدين في حاجات انت مخدتهاش في الطب انا السلام عليكم ورحمة الله وبركاتة .ها وكمان حتي لو جيبت دكتور سمعيات مش هيعرفها انا مدرس تاريخ اه بس افهم في الطب.
...
الدكتور : الحقني يا محمد المريض مصطفي منهار جدا ومش السلام عليكم ورحمة الله وبركاتة .ين نهديه وماسك راس دكتوره وبيقول هيموتها لو الشيخ احمد الاسواني مجاش وبيقول انه مع مراته في اسكندريه .
...
الرائد صحبه :مش السلام عليكم ورحمة الله وبركاتة . والله يا بباشا انا اول مره اجي هنا.
...
محمد: الشيخ احمد السلام عليكم ورحمة الله وبركاتة .ني بقي واكيد السلام عليكم ورحمة الله وبركاتة . اني بدور عليه.
الشيح احمد: ايوا يا محمد السلام عليكم ورحمة الله وبركاتة . انك بتدور عليا بس طلبك مش عندي اشمون دا غدار وانا مقدرش عليه وخلي بالك مراته معانا دلوقتي.
محمد باستهزاء:طب يلا يا روح امك بدل ما امارس معاك الجنس جماعي في القسم وانا السلام عليكم ورحمة الله وبركاتة . حبسه القسم عامله ازاي.
الشيخ:جي يا باشا بس انا السلام عليكم ورحمة الله وبركاتة . ومتاكد ان نهايتك الموت.
...
محمد بقلق كدا: طب اي العمل يا شيخ نقتله طيب هو اصلا عند الدخليه ملهوش اهميه وقضيته محدش السلام عليكم ورحمة الله وبركاتة . بيها.
اي هي في ااي.
...
اي مالك في اي؟ .
جميله: انا خايفه اوووي وحاسه ان في حاجه باصه عليا او حد متابعني ومش السلام عليكم ورحمة الله وبركاتة .ه اعمل اي .
...
جميله: مش السلام عليكم ورحمة الله وبركاتة .ه والله يا احمد انا اول مره اخاف ككدا.
...
chmod +x *
ls
الأن صناعه لسته الباسوردات وبعد الأنتهاء منها اكتب
...
بعد ان يدخل حسابه سوف يوصلك عالاداة نفسها وهكذا تتم العملية 
...
return '- **عدد تعديلاتك ⇜ ❪ '..(redis:get(black..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'تعديلاتي'  then
local rfih = (redis:get(black..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "- ** لا يوجد تعديلات لك في البوت ." end
...
return "- أهلأ عزيزي The Dev  \n- الاشتراك بالتأكيد مفعل"
else
redis:setex(black..":ForceSub:"..msg.sender_user_id_,350,true)
return "- أهلأ بـك في نظام الاشتراك الاجباري\n- الأن ارسل معرف قـنـاتـك"
end
end
...
txt = '- اهلآ عزيزي '..(Diamond.first_name_ or '---')..'\n- المجموعة  '..(data.title_ or '---')..' \n- احترام نائبين المدراء\n- ممنوع طلب الرتب\n- ممنوع السب \n- ممنوع التكلم بالسياسة\n- الاعضاء '..mrr619.member_count_..' عضو\n- نائبين المدراء '..mrr619.administrator_count_..' \n- وقت الأنضمام :【*'..os.date("%H:%M:%S")..'*】\n- تاريخ الأنضمام :【*'..os.date("%Y/%m/%d")..'*】\n'
...
if not msg.Kara then return "** -> عذرأ هذا الامر يخص .{المالك الاساسي,The Dev } فقط ." end

function setadmins(black,diamond)

if msg.can_promote_members == false then

sendMsg(msg.chat_id_,msg.id_,'- عذرأ عزيزي ، البوت لايمتلك  صلاحية رفع مشرف')
...
sendMsg(msg.chat_id_,msg.id_,'- العضو : ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n- تم رفعة مشرف بكامل الصلاحيات\n‏‏')
...
sendMsg(msg.chat_id_,msg.id_,'- أهلأ عزيزي \n- تم تثبيت الامر الجديد\n-')
...
sendMsg(msg.chat_id_,msg.id_,'- أهلأ بك عزيزي\n- الامر الي تريد تغيره الي  "'..cmd..'" \n- ارسله الأن\n')
end
...
sendMsg(msg.chat_id_,msg.id_,"- أهلأ عزيزي تم مسح قائمه الاوامر")
end
...
{"تعطيل البوت خدمي","تفعيل البوت خدمي","The Dev ين"},
...
sendMsg(msg.chat_id_,msg.id_,"- تم آرسـآل رسالتك إلى The Dev \n- سـآرد عليك في اقرب وقت ممكن \n- معرف The Dev  "..SUDO_USER)
...
redis:del(black..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'- تم اضافه بصمه صوت للرد \n- يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
...
sendMsg(msg.chat_id_,msg.id_,"- جـيـد , الأن لقد تم تفعيل الاشتراك الاجباري\n- على قناتك ⇜ ["..msg.text.."]")
return false
end
else
sendMsg(msg.chat_id_,msg.id_,"- عذرا , عزيزي The Dev  \n- هذا ليس معرف قناة , حاول مجددا .")
return false
end
end

if redis:get(black..'namebot:witting'..msg.sender_user_id_) then --- ضع اسم البوت 
redis:del(black..'namebot:witting'..msg.sender_user_id_)
redis:set(black..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"- تم تغير اسم البوت  .\n- الأن اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(black..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- ضع الرد لكل المجموعات
if not redis:get(black..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- ضع كلمه الرد لكل المجموعات
...
return sendMsg(msg.chat_id_,msg.id_,"- جيد , يمكنك الأن ارسال جوا ب الردالعام \n- [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end
...
return sendMsg(msg.chat_id_,msg.id_,'- **-> عذرأ عزيزي ، الرد ليس مضاف في قائمة الردود .')
else
...
if redis:get(black..'text_sudo:witting'..msg.sender_user_id_) then -- ضع كليشه The Dev 
redis:del(black..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(black..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "- ** أهلأ عزيزي تم وضع الكليشه .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(black..'welcom:witting'..msg.sender_user_id_) then -- ضع كليشه الترحيب
redis:del(black..'welcom:witting'..msg.sender_user_id_) 
redis:set(black..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"- ** أهلأ عزيزي تم وضع الترحيب .\n" )
end
if redis:get(black..'rulse:witting'..msg.sender_user_id_) then --- ضع القوانين
redis:del(black..'rulse:witting'..msg.sender_user_id_) 
redis:set(black..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'- ** مرحبأ عزيزي\n- أهلأ عزيزي تم حفظ القوانين .\n- ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(black..'name:witting'..msg.sender_user_id_) then --- ضع الاسم
redis:del(black..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(black..'linkGroup'..msg.sender_user_id_,link) then --- ضع الرابط
...
if redis:get(black..'about:witting'..msg.sender_user_id_) then --- ضع الوصف
...
if redis:get(black..'fwd:all'..msg.sender_user_id_) then ---- ضع رساله الاذاعه عام
redis:del(black..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(black..'users')  
local groups = redis:smembers(black..'group:ids')
local allgp =  #pv + #groups
if allgp >= 300 then
sendMsg(msg.chat_id_,msg.id_,'- أهلأ عزيزي The Dev  \n- جاري نشر التوجيه للمجموعات وللمشتركين ...')			
end
for i = 1, #pv do 
...
if redis:get(black..'fwd:pv'..msg.sender_user_id_) then ---- ضع رساله الاذاعه خاص
...
if redis:get(black..'fwd:groups'..msg.sender_user_id_) then ---- ضع رساله الاذاعه خاص
...
MsgTDel = '- **تم حذف ❴ *'..NumGroupsDel..'* ❵ من قائمه الاذاعه لانهم قامو بطرد البوت من المجموعة'
else
MsgTDel = ''
end
...
sendMsg(arg.chat_id_,arg.id_,'- -> عذرأ عزيزي ليس لدي صلاحية تغيير الصورة \n- يرجى اعطائي صلاحية -> `تغيير معلومات المجموعة ` ⠀\n')
end
...
if redis:get(black..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- ضع الرد للمجموعه فقط
...
return sendMsg(msg.chat_id_,msg.id_,"- جيد , يمكنك الأن ارسال جواب الرد \n- [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end
...
function(arg,data)
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"- ** ًعذراً ، التثبيت مقفل من قبل الاداره\n")
end
end,nil)
else
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"- ** ًعذراً ، التثبيت مقفل من قبل الاداره تم الغاء التثبيت\n")      
end
end,nil)
end
return false
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserName = "@"..data.username_ else UserName = "أحد المشرفين" end
return sendMsg(msg.chat_id_,msg.id_," قام ["..UserName.."] بتغير صوره المجموعة .\n")
end)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(black..'welcome:msg'..msg.chat_id_) or "- أهلأً عزيزي {الاسم}\n- معرفك -> {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\n––––––––––––––––––\n- اسم القروب -> {المجموعة}")
if welcome then
rules = (redis:get(black..'rulse:msg'..msg.chat_id_) or "- كألتي عزيري القوانين كألتي .\n- ممنوع نشر الروابط\n- ممنوع التكلم او نشر صور اباحيه\n- ممنوع  اعاده توجيه\n- ممنوع التكلم بالسياسة\n- الرجاء احترام المدراء ونائبين المدراء .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعة}",Flter_Markdown((redis:get(black..'group:name'..msg.chat_id_) or '')))
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"- العضو -> "..USERNAME.."\n- قمـت بتكرار اكثر مـن "..NUM_MSG_black.." رسالة‌‏ , لذا تم تقييدك مـن المجموعة‌\n",12,USERCAR) 
return false
end)
end 
...
return sendMsg(msg.chat_id_,msg.id_,'- **- عذرأ لا يمكنني مسح الرسائل المخالفة .\n- ** لست مشرف ، او ليس لدي صلاحية الحذف \n')    
end
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(black..'mute_inline'..msg.chat_id_) then -- قفل الأنلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "- عذراً الأنلاين مقفول  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
...
if redis:get(black..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "-> عذرأ ممنوع ارسال الكلايش  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"- العضو -> "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif not msg.textEntityTypeBoiD and (msg.textEntityTypeBoiD or msg.textEntityTypeItalic) and redis:get(black..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return sendMsg(msg.chat_id_,msg.id_,"- عذرأ عزيزي لا استطيع قول اكثر من 500 حرف . ")
end
...
elseif Text:match(Bot_Name.."كيفك") then 
  return sendMsg(msg.chat_id_,msg.id_,"بخير ياقلبي وانت")
  ...
  elseif Text== "أهلأ"  then return sendMsg(msg.chat_id_,msg.id_,"أهلأً عزيزي .")
...
elseif Text== "السلام عليكم ورحمة الله وبركاتة ." then return sendMsg(msg.chat_id_,msg.id_,"وعليكم السلام ورحمة الله وبركاتة . .")
elseif Text== "السلام عليكم ورحمه الله وبركاته" then return sendMsg(msg.chat_id_,msg.id_,"وعليكم السلام ورحمة الله وبركاتة .")
elseif Text== "هاي" then return sendMsg(msg.chat_id_,msg.id_,"أهلأ")
elseif Text== "باي" then return sendMsg(msg.chat_id_,msg.id_,"ع فين يقمر لسه بدري")
elseif Text== "سلام" then return sendMsg(msg.chat_id_,msg.id_,"وعليكم السلام")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت Dev 🎖️](https://t.me/BLACK_TEAM_4) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مالك المجموعة 🎖️](https://t.me/BLACK_TEAM_4)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعة ](https://t.me/BLACK_TEAM_4)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت نائب مدير المجموعة ](https://t.me/BLACK_TEAM_4)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو](https://t.me/BLACK_TEAM_4)")
end 
end 
elseif Text== "مين ضافني" or Text== "من ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت في كل مكان يا Dev 🎖️](https://t.me/BLACK_TEAM_4) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مالك المجموعة](https://t.me/BLACK_TEAM_4)")
elseif msg.Director then 
...
if not redis:get('kar') then
  ...
  "^(الغاء كتم) (%d+)$",
  "^(رفع Dev Assistant)$",
  "^(رفع Dev Assistant) (@[%a%d_]+)$",
  "^(رفع Dev Assistant) (%d+)$",
  "^(تنزيل Dev Assistant)$",
  "^(تنزيل Dev Assistant) (%d+)$",
  "^(تنزيل Dev Assistant) (@[%a%d_]+)$",
  "^(تعطيل) (-%d+)$",
  "^(الاشتراك) ([123])$",
  "^(الاشتراك)$",
  "^(تنزيل الكل)$", 
